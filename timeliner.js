...
var Tweens = {
  ...
  quadEaseIn: function(t, b, _c, d) {
    var c = _c - b;
    return c * (t /= d) * t + b;
  },
  quadEaseOut: function(t, b, _c, d) {
    var c = _c - b;
    return -c * (t /= d) * (t - 2) + b;
  },
  quadEaseInOut: function(t, b, _c, d) {
    var c = _c - b;
    if ((t /= d / 2) < 1) {
      return c / 2 * t * t + b;
    } else {
  ...
  easeInBounce: function(t, b, _c, d) {
    var c = _c - b;
    var v;
    v = Tweens.easeOutBounce(d - t, 0, c, d);
    return c - v + b;
  },
  ...
  easeInOutBounce: function(t, b, _c, d) {
    ...
    var v;
    if (t < d / 2) {
      v = Tweens.easeInBounce(t * 2, 0, c, d);
      return v * 0.5 + b;
    } else {
      v = Tweens.easeOutBounce(t * 2 - d, 0, c, d);
...
function timeAtLayer(layer, t) {
	...
	for (i=0; i<il; i++) {
		...
		if (t < entry.time) {
			...
			var currentTime = t;
			var beginValue = prev_entry.value;
			var endValue = entry.value;
			var totalDuration = entry.time - prev_entry.time;
			var new_value = Tweens[tween](currentTime, beginValue, endValue, totalDuration);
